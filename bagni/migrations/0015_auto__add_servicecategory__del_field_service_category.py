...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bagni_servicecategory', (
        ...
        db.send_create_signal(u'bagni', ['ServiceCategory'])

        # Deleting field 'Service.category'
        db.delete_column(u'bagni_service', 'category')


    def backwards(self, orm):
        # Deleting model 'ServiceCategory'
        db.delete_table(u'bagni_servicecategory')

        # Adding field 'Service.category'
        db.add_column(u'bagni_service', 'category',
                      self.gf('django.db.models.fields.CharField')(default='NS', max_length=50, blank=True),
                      keep_default=False)
