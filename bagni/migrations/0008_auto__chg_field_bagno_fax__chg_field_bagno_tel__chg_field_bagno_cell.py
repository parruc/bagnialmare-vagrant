...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bagni_bagno', 'fax', self.gf('django.db.models.fields.CharField')(max_length=125))

        # Changing field 'Bagno.tel'
        db.alter_column(u'bagni_bagno', 'tel', self.gf('django.db.models.fields.CharField')(max_length=125))

        # Changing field 'Bagno.cell'
        db.alter_column(u'bagni_bagno', 'cell', self.gf('django.db.models.fields.CharField')(max_length=125))
