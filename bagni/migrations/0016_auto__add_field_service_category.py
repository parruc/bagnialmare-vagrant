...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bagni_service', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bagni.ServiceCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.category'
        db.delete_column(u'bagni_service', 'category_id')
