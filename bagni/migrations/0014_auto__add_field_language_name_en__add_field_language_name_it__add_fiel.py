...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bagni_language', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.name_it'
        db.add_column(u'bagni_language', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.slug_en'
        db.add_column(u'bagni_language', 'slug_en',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.slug_it'
        db.add_column(u'bagni_language', 'slug_it',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'bagni_language', 'name_en')

        # Deleting field 'Language.name_it'
        db.delete_column(u'bagni_language', 'name_it')

        # Deleting field 'Language.slug_en'
        db.delete_column(u'bagni_language', 'slug_en')

        # Deleting field 'Language.slug_it'
        db.delete_column(u'bagni_language', 'slug_it')
