...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bagni_language', (
        ...
        db.send_create_signal(u'bagni', ['Language'])

        # Adding M2M table for field languages on 'Bagno'
        m2m_table_name = db.shorten_name(u'bagni_bagno_languages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bagno', models.ForeignKey(orm[u'bagni.bagno'], null=False)),
            ('language', models.ForeignKey(orm[u'bagni.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bagno_id', 'language_id'])


    def backwards(self, orm):
        # Deleting model 'Language'
        db.delete_table(u'bagni_language')

        # Removing M2M table for field languages on 'Bagno'
        db.delete_table(db.shorten_name(u'bagni_bagno_languages'))
