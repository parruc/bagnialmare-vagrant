...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bagno.name'
        db.alter_column(u'bagni_bagno', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Bagno.name'
        db.alter_column(u'bagni_bagno', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))
