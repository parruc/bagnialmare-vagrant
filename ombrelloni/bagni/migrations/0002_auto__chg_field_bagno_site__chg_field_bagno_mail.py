...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bagni_bagno', 'site', self.gf('django.db.models.fields.URLField')(max_length=100))

        # Changing field 'Bagno.mail'
        db.alter_column(u'bagni_bagno', 'mail', self.gf('django.db.models.fields.CharField')(max_length=100))
